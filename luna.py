...
Further developed with algorithms/equations from
"How to Compute Planetary Positions" by Paul Schlyter,
http://www.stjarnhimlen.se/comp/ppcomp.html#20
"""
...
class Luna(object):
    ...
    def calculate(self, y, m, d, h, mins, second):
        ...
        dlon += 0.658 * sin(2 * dm)  # the Variation
        ...
        dlon -= 0.035 * sin(dm)  # The Parallactic Equation
        ...
        (+90 or -90 degrees). The above formula had been giving latitudes
        in the range 355 - 365 degress. Added a few statements to correct
        for this
        """
        ...
        # now to find the cartesian coordinates of geocentric lunar position
        ...
        # see http://www.stjarnhimlen.se/comp/ppcomp.html#12b for more info
        mpar = asin(1 / rm)
        msd = asin(0.2725 / rm)
        alttopoc = alt - mpar * cos(alt)
        altdegrees = degrees(alttopoc)

        # calculate "geocentric lattitude" accounting for earth obliqueness:
        ...
        return [azdegrees, altdegrees, ra, dec, phase, topRA, topDecl,
                mpar, msd, londegrees, latdegrees, gmsto, d]
